...
This document describes the current PostgreSQL schema for `customer-support` and points to the code file that maps each table.

## Source of truth

- Source schema: [`src/main/resources/db/migration/V1__baseline.sql`](../src/main/resources/db/migration/V1__baseline.sql)
- JPA entity:
